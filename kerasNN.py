...
def split_sign_dataset():
    ...
    test, l_test = data[-test_size:], labels[-test_size:]

    print("Train len:", len(train))
    print("Test len:", len(test))

    return train, l_train, test, l_test

train, l_train, test, l_test = split_sign_dataset()
...
#
# model.save_weights("64-soft-20-CNN.hdf5", True)
